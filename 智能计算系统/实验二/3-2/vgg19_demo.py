...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        # pooling
        pool_shape1 = pycnnl.IntVector(4)
        pool_shape1[0]=1
        pool_shape1[1]=64
        pool_shape1[2]=224
        pool_shape1[3]=224
        self.net.createPoolingLayer('pool1', pool_shape1, 2, 2)
        ...
        pool_shape2 = pycnnl.IntVector(4)
        pool_shape2[0]=1
        pool_shape2[1]=128
        pool_shape2[2]=112
        pool_shape2[3]=112
        self.net.createPoolingLayer('pool2', pool_shape2, 2, 2)
        ...
        pool_shape3 = pycnnl.IntVector(4)
        pool_shape3[0]=1
        pool_shape3[1]=256
        pool_shape3[2]=56
        pool_shape3[3]=56
        self.net.createPoolingLayer('pool3', pool_shape3, 2, 2)
        ...
        # pool_shape4 = pycnnl.IntVector(2)
        # pool_shape4[0]=28
        # pool_shape4[1]=28
        # self.net.createPoolingLayer('pool4', pool_shape4, 2, 2)
        pool_shape4 = pycnnl.IntVector(4)
        pool_shape4[0]=1
        pool_shape4[1]=512
        pool_shape4[2]=28
        pool_shape4[3]=28
        ...
        # pool_shape5 = pycnnl.IntVector(2)
        # pool_shape5[0]=14
        # pool_shape5[1]=14
        # self.net.createPoolingLayer('pool5', pool_shape5, 2, 2)

        pool_shape5 = pycnnl.IntVector(4)
        pool_shape5[0]=1
        pool_shape5[1]=512
        pool_shape5[2]=14
        pool_shape5[3]=14
    ...
    def load_image(self, image_dir):
        ...
        # TODO：调整输入数据
        # input_image = np.transpose(input_image, (0, 1, 2, 3)).astype(np.float)
